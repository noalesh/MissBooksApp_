...
// PLEASE NOTICE! - in order to create random data - uncomment below
// and comment the line below it.
//_createBooks()
_createBooksFromGivenDemoData()
...
function getEmptyBook(id="", title="", subtitle="", authors=[], 
    ...
    function _createBooksFromGivenDemoData() {

          // below is hard-coded demp data given by the course team.
